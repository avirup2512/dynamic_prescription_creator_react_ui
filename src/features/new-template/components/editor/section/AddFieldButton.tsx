...
function AddFieldButton({ rowIndex, columnIndex, inputGroupIndex, sectionType, sectionId }: any) {
    const navigate = useNavigate();
    const { id } = useParams();
    return (
        <button
            type="button"
            onClick={() => navigate(`/dashboard/new-template/edit/${id}/input/${id}/${rowIndex}/${columnIndex}/${inputGroupIndex}/${sectionType}/${sectionId}/inputs/INPUT_TYPE_1`)}
