      ...
      <div className="max-h-[330px] space-y-1 overflow-y-auto pr-1">
        {items.map((item) => {
          ...
          return (
            ...
            >
              <span className="flex h-7 w-7 shrink-0 items-center justify-center border border-slate-200 bg-white text-slate-500">
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="block truncate text-[11px] text-slate-400">{item.value}</span>
              </span>
              <span
                key={item.value}
